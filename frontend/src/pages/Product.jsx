...
{/* product data */}
                        ...
                        <div className="flex flex-col gap-4 my-8">
                            ...
                            <div className="flex gap-2">
                                {productData.sizes.map((item, index) => (
                                    <button onClick={() => setSize(item)} key={index} className={`border px-4 py-2 bg-gray-100 ${item === size ? 'border-orange-500' : ''}`}>{item}</button>
                                ))}
                            </div>
                        </div>
            ...
            <div className="mt-20">
                ...
                <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, nobis. Impedit aperiam natus, ducimus nobis aliquid quaerat tenetur unde deserunt non, nostrum temporibus tempora nulla laboriosam blanditiis magnam rerum molestias?</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, nobis. Impedit aperiam natus, ducimus nobis aliquid quaerat tenetur unde deserunt non, nostrum temporibus tempora nulla laboriosam blanditiis magnam rerum molestias?</p>
                </div>
            </div>
